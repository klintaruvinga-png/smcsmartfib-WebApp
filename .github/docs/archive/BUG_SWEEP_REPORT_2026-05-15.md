...
**If both soaks pass**: 4. Commit Phase 0 closeout evidence to `.github/migration/phase-updates/` 5. Update `.github/migration/PHASE0_SOAK_TRACKER.md` with soak completion status 6. Run `/mt5-migration Phase 0 readiness check` to confirm gate clearance 7. Begin Phase 1 planning: MT5 bridge infrastructure setup
