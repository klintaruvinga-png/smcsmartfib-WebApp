...
| RISK-04 | NAS100 / US30 not in EA Symbols input — these two equity indices are offline and will remain so until operator adds them to EA Properties → Inputs → Symbols | MEDIUM | CERTAIN | Reduces watchlist coverage to 22/24 symbols; Phase 4 fib data for NAS100/US30 will be absent | Operator | Add `NAS100,US30` to EA Symbols input during next MT5 session | OPEN |
