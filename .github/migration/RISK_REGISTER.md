...
| RISK-06 | ~~T0 admin baseline capture not yet done~~ — **RESOLVED 2026-05-27**: Phase 4 soak workspace baseline captured/exported (`PHASE_4_30_DAY`; baseline row visible in `phase-4-30-day-2026-05-27.md`) | LOW | RESOLVED | None | — | — | RESOLVED |
