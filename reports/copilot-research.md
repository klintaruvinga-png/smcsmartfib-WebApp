...
4. Shared-quote TTL alignment: ensure `fetch_shared_market_quote()` uses the exact same stale thresholds as `is_engine_snapshot_current()` to avoid mismatched expectations.
