...
test('computeFibAnchors matches baseline anchor fixtures', () => {
  ...
  fixtures.forEach((fixture) => {
    ...
    assert.equal(result._meta.sessionTf, fixture.expected.sessionTf, fixture.name + ' sessionTf');
    assert.equal(result._meta.s1.key, fixture.expected.sessions.s1.key, fixture.name + ' s1 key');
    assert.equal(result._meta.s2.key, fixture.expected.sessions.s2.key, fixture.name + ' s2 key');
    ...
    assert.equal(Object.prototype.hasOwnProperty.call(fixture.expected, 'ef'), true, fixture.name + ' EF field declared');
  });
});
