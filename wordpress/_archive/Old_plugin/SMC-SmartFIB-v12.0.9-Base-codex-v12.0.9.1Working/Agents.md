Run a forensic audit on F1, F2, and F3 in this Pine indicator.
...
- verify the anchor direction
- verify the fib level math
...
4. exact function/variable/formula mismatches
5. a minimal fix recommendation

Do not patch first. Audit first.