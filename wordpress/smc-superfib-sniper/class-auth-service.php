<?php
/**
 * Authentication and permission checks for SMC SuperFIB REST routes.
 */
...
final class SMC_SuperFib_Auth_Service {
    ...
    public function permission_ea_bridge(WP_REST_Request $request) {
        ...
        $ea_user_id = (int) $this->request_value($request, $payload, 'user_id', 0);
        if ($ea_user_id <= 0) {
    ...
    private function request_value(WP_REST_Request $request, array $payload, $key, $default = null) {
