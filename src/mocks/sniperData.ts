...
export const mockPrices: PairPrice[] = [
  ...
  { symbol: "AUDUSD", bid: 0.6582, ask: 0.6583, mid: 0.65825, changePct1d: -0.18, updatedAt: now(), state: "mock" },
  { symbol: "EURUSD", bid: 1.0823, ask: 1.0824, mid: 1.08235, changePct1d: 0.11, updatedAt: now(), state: "mock" },
  { symbol: "NZDUSD", bid: 0.6011, ask: 0.6013, mid: 0.6012, changePct1d: -0.34, updatedAt: minutesAgo(4), state: "stale" },
  { symbol: "USDJPY", bid: 156.42, ask: 156.45, mid: 156.435, changePct1d: 0.61, updatedAt: now(), state: "mock" },
  { symbol: "AUDJPY", bid: 102.95, ask: 102.99, mid: 102.97, changePct1d: 0.45, updatedAt: minutesAgo(6), state: "stale" },
  { symbol: "EURJPY", bid: 169.38, ask: 169.41, mid: 169.395, changePct1d: 0.72, updatedAt: now(), state: "mock" },
  { symbol: "XAUUSD", bid: 2331.4, ask: 2331.9, mid: 2331.65, changePct1d: -0.22, updatedAt: now(), state: "unavailable" },
];
...
export const mockOrders: PendingOrder[] = [
  { id: "ord-1", symbol: "GBPUSD", direction: "LONG", type: "LIMIT", price: 1.2662, lots: 0.16, sl: 1.2628, tp: 1.2738, placedAt: minutesAgo(3), state: "mock" },
  { id: "ord-2", symbol: "GBPUSD", direction: "LONG", type: "LIMIT", price: 1.265, lots: 0.22, sl: 1.2628, tp: 1.2782, placedAt: minutesAgo(3), state: "mock" },
  { id: "ord-3", symbol: "USDJPY", direction: "LONG", type: "LIMIT", price: 156.0, lots: 0.12, sl: 155.6, tp: 156.9, placedAt: minutesAgo(10), state: "mock" },
  { id: "ord-4", symbol: "EURJPY", direction: "LONG", type: "STOP", price: 169.5, lots: 0.1, sl: 169.0, tp: 170.4, placedAt: minutesAgo(2), state: "pending-sync" },
];
